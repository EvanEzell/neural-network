...
def main():
    ...
    if sys.argv[1] == 'example':
        ...
        num_neurons = [2,1]
        #weights = "random"
        weights = [[[-0.06782947598673161, 0.22341077197888182, -0.4635107399577998],
                   [0.9487814395569221, 0.461587116462548, 0.09750161997450091]],
                   [[-0.22791948943117624,0.581714099641357,0.7792991203673414]]]
